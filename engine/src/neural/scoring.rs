...
use super::tokenizer::{hiragana_to_katakana, BpeTokenizer, CHAR_CONTEXT, CHAR_INPUT, CHAR_OUTPUT};
...
impl NeuralScorer {
    ...
    pub(super) fn forward_all(&mut self, tokens: &[u32]) -> anyhow::Result<Vec<Tensor>> {
...
pub(super) fn find_subsequence(haystack: &[u32], needle: &[u32]) -> Option<usize> {
